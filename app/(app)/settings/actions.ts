...
export async function exportAllData(): Promise<Record<string, unknown>> {
  ...
  const [
    ...
    supabase.from("split_templates").select("*"),
    supabase.from("split_template_shares").select("*"),
  ...
  return {
    ...
    split_templates: splitTemplates.data,
    split_template_shares: splitTemplateShares.data,

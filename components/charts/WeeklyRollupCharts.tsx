        ...
        <div style={{ width: "100%", height: 260 }}>
          <ResponsiveContainer>
            <LineChart data={rows} margin={{ top: 4, right: 8, left: 0, bottom: 0 }}>
              ...
              <Line type="monotone" dataKey="total_income" name="Income" stroke={CHART_LINE_COLOR} strokeWidth={2} dot={false} activeDot={{ r: 4, stroke: "#0b1326", strokeWidth: 2 }} />
              <Line type="monotone" dataKey="total_expenses" name="Spent" stroke={CHART_LINE_SECONDARY} strokeWidth={2} dot={false} activeDot={{ r: 4, stroke: "#0b1326", strokeWidth: 2 }} />
            </LineChart>
          </ResponsiveContainer>
        </div>
      </Glass>
